...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/adiknurhalimah/",
    color: "#F04470",
    gradient: "from-[#F04470] to-[#D62965]",
    isPrimary: true,
  },
  {
    name: "Instagram",
    ...
    subText: "@aaadiknh_",
    icon: Instagram,
    url: "https://www.instagram.com/aaadiknhh_",
    color: "#F04470",
    gradient: "from-[#F58AA7] via-[#F04470] to-[#D62965]",
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@aadikko",
    icon: Youtube,
    url: "https://www.youtube.com/@aadikko",
    color: "#F04470",
    gradient: "from-[#F04470] to-[#D62965]",
  },
  {
  ...
  },
  {
    ...
    url: "https://tiktok.com/@aaadiikh_",
    color: "#F04470",
    gradient: "from-[#F04470] to-[#D62965]",
  },
];
      ...
      >
        <span
          className="
            ...
            from-[#F04470]
            to-[#D62965]
            shadow-[0_0_12px_rgba(240,68,112,0.7)]
          "
        />
        Connect With Me
      </h3>
      <div className="flex flex-col gap-4">
        <a
          ...
          className="
            ...
            border-white/[0.14]
            overflow-hidden
            hover:border-[#F04470]/50
            hover:bg-white/[0.11]
            hover:shadow-[0_0_30px_rgba(240,68,112,0.12)]
            transition-all
            duration-500
          "
          data-aos="fade-up"
              ...
              >
                <linkedIn.icon
                  className="
                    ...
                    group-hover:drop-shadow-[0_0_8px_rgba(240,68,112,0.8)]
                  "
                />
              </div>
            </div>
          ...
          {[instagram, youtube].map((link, index) => (
            <a
              ...
              className="
                ...
                hover:border-[#F04470]/50
                hover:bg-white/[0.11]
                hover:shadow-[0_0_25px_rgba(240,68,112,0.10)]
                transition-all
                duration-500
              "
              data-aos="fade-up"
                ...
                >
                  <link.icon
                    className="
                      ...
                      group-hover:scale-110
                      group-hover:text-[#F58AA7]
                      group-hover:drop-shadow-[0_0_7px_rgba(240,68,112,0.75)]
                    "
                  />
                </div>
              </div>
